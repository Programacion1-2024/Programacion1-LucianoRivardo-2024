...
namespace La_Conjetura_de_Collatz
{
    ...
    /*
        Consigna: 
            ...
            Tome cualquier número entero positivo n. Si n es par, divide n entre 2 para obtener n/2. 
    Si n es impar, multiplica n por 3 y suma 1 para obtener 3n + 1. Repite el proceso indefinidamente.
    La conjetura afirma que no importa con qué número comiences, eventualmente siempre llegarás a 1.
