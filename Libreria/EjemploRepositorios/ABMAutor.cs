...
namespace CPresentacion
{
    public partial class ABMAutor : Form
    {
        ...
        private void ConfigureDataGridView()
        {
            ...
            modificarButtonColumn.Name = "btnEliminarColumna";
            modificarButtonColumn.HeaderText = "";
            modificarButtonColumn.Text = "Eliminar";
            modificarButtonColumn.UseColumnTextForButtonValue = true;
            dgvListadoAutores.Columns.Add(modificarButtonColumn);
            CargarListadoAutores();
            modificarButtonColumn.DisplayIndex = dgvListadoAutores.Columns.Count - 1;
        ...
        private void tbIdAutorModificacion_TextChanged(object sender, EventArgs e)
        {
