...
namespace CLogica.Implementations
{
    public class EmpleadoLogic : IEmpleadoLogic
    {
        ...
        {
            Empleado empleadoExistente = _empleadoRepository.FindByCondition(a => a.Documento == documentoEmpleado).FirstOrDefault();
        ...
        {
            Empleado empleado = _empleadoRepository.FindByCondition(a => a.Documento == documentoEmpleado).FirstOrDefault();
            if (empleado == null)
                throw new ArgumentException("Empleado no encontrado");
