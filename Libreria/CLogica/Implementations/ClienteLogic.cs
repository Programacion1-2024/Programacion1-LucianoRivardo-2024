...
namespace CLogica.Implementations
{
    public class ClienteLogic : IClienteLogic
    {
        ...
        {
            Cliente clienteExistente = _clienteRepository.FindByCondition(a => a.Documento == documentoCliente).FirstOrDefault();
        ...
        {
            Cliente cliente = _clienteRepository.FindByCondition(a => a.Documento == documentoCliente).FirstOrDefault();
            if (cliente == null)
