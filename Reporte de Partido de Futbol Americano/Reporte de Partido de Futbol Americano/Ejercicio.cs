namespace Reporte_de_Partido_de_Futbol_Americano
{
    /*
       Consigna: 
           Está desarrollando un sistema para ayudar al personal del sitio web de un club de fútbol a informar sobre los partidos. Este sistema es capaz de analizar diferentes aspectos del partido, tanto dentro como fuera del campo, y convertirlos en un flujo de acontecimientos.
